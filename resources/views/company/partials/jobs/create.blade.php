                ...
                <form method="POST" action="{{ route('jobs.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ old('job_title') }}" class="form-control  @error('job_title') is-invalid @enderror" name="job_title" id="job_title">
                            @error('job_title')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ old('job_require') }}" class="form-control @error('job_require') is-invalid @enderror" name="job_require" id="job_require">
                            @error('job_require')
                                <small class="text-danger"> {{ $message }}</small>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ old('job_location') }}" class="form-control @error('job_location') is-invalid @enderror" name="job_location" id="job_location">
                            @error('job_location')
                                <small class="text-danger"> {{ $message }}</small>
                            @enderror
                        </div>
